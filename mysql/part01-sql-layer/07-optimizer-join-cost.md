...
第6章で論理変換を終えたクエリブロックが、ここで物理的な実行順序を得る。

## 前提

第6章までに、クエリは論理的な変換を受け、結合に参加するテーブルの集合と利用可能なインデックスの候補が確定している。
...
- [第9章 エグゼキュータ（イテレータ実行モデル）](09-executor-iterators.md)
- [第15章 バッファプール](../part02-innodb-foundation/15-buffer-pool.md)
