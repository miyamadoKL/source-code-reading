...
[`src/server.h` L1394-L1399](https://github.com/valkey-io/valkey/blob/9.1.0/src/server.h#L1394-L1399)
...
[`src/server.c` L4385-L4392](https://github.com/valkey-io/valkey/blob/9.1.0/src/server.c#L4385-L4392)
...
比較に使う `time_independent_strcmp` は、一致・不一致にかかわらず常に全文字を走査する定数時間の比較である。
...
`%` 形式では R と W を読み取って読み取り権限・書き込み権限のフラグを組み立て、`~` の後ろをパターン本体とする。
...
[`src/acl.c` L2437-L2468](https://github.com/valkey-io/valkey/blob/9.1.0/src/acl.c#L2437-L2468)
