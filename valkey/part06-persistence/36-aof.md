...
[`src/server.c` L3607-L3619](https://github.com/valkey-io/valkey/blob/9.1.0/src/server.c#L3607-L3619)
...
実際の書き込みは `aofWrite`（`write(2)` の薄いラッパー）で1回行う。
...
[`src/aof.c` L1215-L1236](https://github.com/valkey-io/valkey/blob/9.1.0/src/aof.c#L1215-L1236)
...
[`src/aof.c` L2626-L2656](https://github.com/valkey-io/valkey/blob/9.1.0/src/aof.c#L2626-L2656)
