...
`SETNX`、`SETEX`、`PSETEX`、`GETSET` も同じ `setGenericCommand` を呼ぶ薄いラッパであり、渡すフラグと既定の応答が違うだけである。
...
[`src/t_string.c` L813-L832](https://github.com/valkey-io/valkey/blob/9.1.0/src/t_string.c#L813-L832)
...
[`src/t_string.c` L477-L487](https://github.com/valkey-io/valkey/blob/9.1.0/src/t_string.c#L477-L487)
