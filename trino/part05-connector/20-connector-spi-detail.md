...
- Trino の型システムの基礎（`Type` インタフェースとその実装）を知っていること（第19章）。
...
この契約で最も重要なのは、**プッシュダウンの効果がない場合に必ず `Optional.empty()` を返さなければならない**点である。
...
[`core/trino-spi/src/main/java/io/trino/spi/connector/ConstraintApplicationResult.java` L27-L29](https://github.com/trinodb/trino/blob/482/core/trino-spi/src/main/java/io/trino/spi/connector/ConstraintApplicationResult.java#L27-L29)
...
[`core/trino-spi/src/main/java/io/trino/spi/connector/ConnectorSplitSource.java` L67-L68](https://github.com/trinodb/trino/blob/482/core/trino-spi/src/main/java/io/trino/spi/connector/ConnectorSplitSource.java#L67-L68)
...
[`core/trino-spi/src/main/java/io/trino/spi/connector/ConnectorPageSource.java` L53-L61](https://github.com/trinodb/trino/blob/482/core/trino-spi/src/main/java/io/trino/spi/connector/ConnectorPageSource.java#L53-L61)
...
[`core/trino-spi/src/main/java/io/trino/spi/connector/ConnectorPageSink.java` L69-L70](https://github.com/trinodb/trino/blob/482/core/trino-spi/src/main/java/io/trino/spi/connector/ConnectorPageSink.java#L69-L70)
...
[`core/trino-spi/src/main/java/io/trino/spi/predicate/TupleDomain.java` L289-L307](https://github.com/trinodb/trino/blob/482/core/trino-spi/src/main/java/io/trino/spi/predicate/TupleDomain.java#L289-L307)
...
[`core/trino-spi/src/main/java/io/trino/spi/predicate/ValueSet.java` L27-L31](https://github.com/trinodb/trino/blob/482/core/trino-spi/src/main/java/io/trino/spi/predicate/ValueSet.java#L27-L31)
...
[`core/trino-spi/src/main/java/io/trino/spi/statistics/ColumnStatistics.java` L122-L123](https://github.com/trinodb/trino/blob/482/core/trino-spi/src/main/java/io/trino/spi/statistics/ColumnStatistics.java#L122-L123)
...
- 第18章：Page と Block のデータ構造。`ConnectorPageSource` が返す Page の内部表現。
- 第19章：型システムと関数レジストリ。`ValueSet` の実装選択は `Type.isOrderable()` / `Type.isComparable()` に依存する。
