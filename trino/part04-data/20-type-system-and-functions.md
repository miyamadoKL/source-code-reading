...
[`core/trino-spi/src/main/java/io/trino/spi/type/Type.java` L60-L68](https://github.com/trinodb/trino/blob/482/core/trino-spi/src/main/java/io/trino/spi/type/Type.java#L59-L67)
...
[`core/trino-spi/src/main/java/io/trino/spi/type/AbstractLongType.java` L83-L86](https://github.com/trinodb/trino/blob/482/core/trino-spi/src/main/java/io/trino/spi/type/AbstractLongType.java#L82-L86)
...
[`core/trino-spi/src/main/java/io/trino/spi/type/VarcharType.java` L192-L197](https://github.com/trinodb/trino/blob/482/core/trino-spi/src/main/java/io/trino/spi/type/VarcharType.java#L191-L197)
...
[`core/trino-spi/src/main/java/io/trino/spi/type/ArrayType.java` L229-L238](https://github.com/trinodb/trino/blob/482/core/trino-spi/src/main/java/io/trino/spi/type/ArrayType.java#L228-L238)
...
[`core/trino-spi/src/main/java/io/trino/spi/type/ArrayType.java` L111-L117](https://github.com/trinodb/trino/blob/482/core/trino-spi/src/main/java/io/trino/spi/type/ArrayType.java#L110-L117)
...
[`core/trino-spi/src/main/java/io/trino/spi/type/TypeOperators.java` L78-L88](https://github.com/trinodb/trino/blob/482/core/trino-spi/src/main/java/io/trino/spi/type/TypeOperators.java#L78-L89)
...
[`core/trino-spi/src/main/java/io/trino/spi/type/TypeOperators.java` L221-L228](https://github.com/trinodb/trino/blob/482/core/trino-spi/src/main/java/io/trino/spi/type/TypeOperators.java#L221-L229)
...
- 第19章（Page と Block のデータモデル）：`Type` が読み書きする列指向データ構造の詳細。
- 第15章（集約と Window 関数）：`FunctionManager` を通じて集約関数の実装を取得する流れ。
- 第5章（Analyzer と意味解析）：アナライザが関数を解決し、型を決定する過程。
