...
## 28.1 Fault Tolerant Execution の動機
...
## 28.2 EventDrivenFaultTolerantQueryScheduler の全体設計
...
## 28.4 StageExecution とパーティション管理
...
## 28.5 TaskExecutionClass: 実行クラスの分類
...
## 28.6 SplitAssigner: スプリットの割り当て戦略
...
## 28.7 OutputStatsEstimator: 出力統計による動的調整
...
## 28.10 設計上の工夫: SchedulingQueue による実行クラス分離
