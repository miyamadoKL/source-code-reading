...
[`be/src/exec/pipeline/aggregate/aggregate_blocking_sink_operator.cpp` L101-L138](https://github.com/StarRocks/starrocks/blob/4.1.1/be/src/exec/pipeline/aggregate/aggregate_blocking_sink_operator.cpp#L101-L138)
...
[`be/src/exec/pipeline/aggregate/aggregate_streaming_sink_operator.cpp` L80-L101](https://github.com/StarRocks/starrocks/blob/4.1.1/be/src/exec/pipeline/aggregate/aggregate_streaming_sink_operator.cpp#L80-L101)
...
[`be/src/exec/pipeline/aggregate/aggregate_streaming_sink_operator.cpp` L173-L209](https://github.com/StarRocks/starrocks/blob/4.1.1/be/src/exec/pipeline/aggregate/aggregate_streaming_sink_operator.cpp#L173-L209)
...
Status AggregateStreamingSinkOperator::_push_chunk_by_selective_preaggregation(const ChunkPtr& chunk,
    ...
    // very high aggregation
        ...
        // ... compute_batch_agg_states ...
    } else {
        // middle cases, first aggregate locally and output by stream
        // ... compute_batch_agg_states_with_selection ...
        // ... output_chunk_by_streaming_with_selection ...
    }
    // ...
}
...
[`be/src/exec/aggregator.h` L64-L87](https://github.com/StarRocks/starrocks/blob/4.1.1/be/src/exec/aggregator.h#L64-L87)
...
[`be/src/exec/pipeline/exchange/exchange_sink_operator.cpp` L506-L522](https://github.com/StarRocks/starrocks/blob/4.1.1/be/src/exec/pipeline/exchange/exchange_sink_operator.cpp#L506-L522)
...
Status ExchangeSinkOperator::push_chunk(RuntimeState* state, const ChunkPtr& chunk) {
    ...
    if (_part_type == TPartitionType::UNPARTITIONED || _num_shuffles == 1) {
        // Broadcast: serialize once, send to all channels
        // ...
    } else if (_part_type == TPartitionType::RANDOM) {
        // Round-robin: send to channels in turn
        // ...
    } else if (_part_type == TPartitionType::HASH_PARTITIONED ||
               _part_type == TPartitionType::BUCKET_SHUFFLE_HASH_PARTITIONED) {
        // Hash partition: compute hash, distribute rows to channels
        // ...
    }
    // ...
}
...
```cpp
        ...
        // hash-partition batch's rows across channels
        {
            ...
            // ... evaluate partition exprs and compute hash values ...
            ...
            // ... build row indexes per channel ...
        }
        for (int32_t channel_id : _channel_indices) {
            // ... add_rows_selective for each channel ...
        }
    }
...
[`be/src/exec/pipeline/exchange/sink_buffer.h` L155-L180](https://github.com/StarRocks/starrocks/blob/4.1.1/be/src/exec/pipeline/exchange/sink_buffer.h#L155-L180)
...
[`be/src/exec/pipeline/exchange/exchange_source_operator.h` L27-L48](https://github.com/StarRocks/starrocks/blob/4.1.1/be/src/exec/pipeline/exchange/exchange_source_operator.h#L27-L48)
...
[`be/src/exec/pipeline/exchange/local_exchange.cpp` L190-L207](https://github.com/StarRocks/starrocks/blob/4.1.1/be/src/exec/pipeline/exchange/local_exchange.cpp#L190-L207)
