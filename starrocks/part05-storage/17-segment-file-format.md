...
[`be/src/storage/rowset/segment_writer.cpp` L418-L442](https://github.com/StarRocks/starrocks/blob/4.1.1/be/src/storage/rowset/segment_writer.cpp#L418-L442)
...
[`gensrc/proto/segment.proto` L172-L201](https://github.com/StarRocks/starrocks/blob/4.1.1/gensrc/proto/segment.proto#L172-L201)
...
[`be/src/storage/rowset/segment.cpp` L100-L112](https://github.com/StarRocks/starrocks/blob/4.1.1/be/src/storage/rowset/segment.cpp#L100-L112)
...
[`gensrc/proto/segment.proto` L74-L96](https://github.com/StarRocks/starrocks/blob/4.1.1/gensrc/proto/segment.proto#L74-L96)
...
[`be/src/storage/rowset/segment_writer.cpp` L449-L501](https://github.com/StarRocks/starrocks/blob/4.1.1/be/src/storage/rowset/segment_writer.cpp#L449-L501)
...
[`be/src/storage/rowset/segment_writer.cpp` L346-L396](https://github.com/StarRocks/starrocks/blob/4.1.1/be/src/storage/rowset/segment_writer.cpp#L346-L396)
...
[`be/src/storage/rowset/column_writer.cpp` L489-L513](https://github.com/StarRocks/starrocks/blob/4.1.1/be/src/storage/rowset/column_writer.cpp#L489-L513)
...
[`be/src/storage/rowset/segment.cpp` L267-L285](https://github.com/StarRocks/starrocks/blob/4.1.1/be/src/storage/rowset/segment.cpp#L267-L285)
...
[`be/src/storage/rowset/column_reader.cpp` L131-L175](https://github.com/StarRocks/starrocks/blob/4.1.1/be/src/storage/rowset/column_reader.cpp#L131-L175)
...
//      library such that the input/output is a multiple of 8.
//
//    <elem_size_bytes> [32-bit]
//      The size of the elements, in bytes, as actually encoded.
//
// 2. Element data
//
...
[`be/src/storage/rowset/bitshuffle_page.h` L201-L228](https://github.com/StarRocks/starrocks/blob/4.1.1/be/src/storage/rowset/bitshuffle_page.h#L201-L228)
...
[`be/src/storage/rowset/bitshuffle_page.h` L401-L419](https://github.com/StarRocks/starrocks/blob/4.1.1/be/src/storage/rowset/bitshuffle_page.h#L401-L419)
...
[`be/src/storage/rowset/page_handle.h` L47-L95](https://github.com/StarRocks/starrocks/blob/4.1.1/be/src/storage/rowset/page_handle.h#L47-L95)
...
[`be/src/storage/rowset/bitshuffle_wrapper.cpp` L90-L114](https://github.com/StarRocks/starrocks/blob/4.1.1/be/src/storage/rowset/bitshuffle_wrapper.cpp#L90-L114)
