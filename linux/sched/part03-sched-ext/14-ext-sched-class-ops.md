# 第14章 ext_sched_class と sched_ext_ops
...
[ランキューとスケジューリングクラスの階層](../part01-core/07-runqueue-sched-class.md) と [try_to_wake_up と wakeup の中核](../part01-core/09-try-to-wake-up.md) を読んでいること。
...
- [DSQ とディスパッチ実行の流れ](15-dsq-dispatch-flow.md)
