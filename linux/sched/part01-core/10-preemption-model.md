# 第10章 プリエンプションモデル（PREEMPT_NONE から PREEMPT_LAZY まで）
...
[__schedule とコンテキストスイッチ](08-schedule-context-switch.md) と [try_to_wake_up と wakeup の中核](09-try-to-wake-up.md) を読んでいること。
