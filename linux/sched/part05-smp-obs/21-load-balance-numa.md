...
[sched domain とトポロジ構築](19-topology-sched-domains.md) と [PELT による負荷追跡](20-pelt-load-tracking.md) を読んでいること。
[group scheduling と cgroup 階層](../part02-eevdf/13-group-scheduling-cgroup.md) も参照する。
