...
[sched domain とトポロジ構築](20-topology-sched-domains.md) を読んでいること。
...
非対称 capacity では第20章の `SD_ASYM_CPUCAPACITY` と組み合わせ、同じ `util_avg` でも実効スループットが異なる CPU へはより多くタスクを置ける。
