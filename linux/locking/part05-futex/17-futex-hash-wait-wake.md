...
- [waitqueue](../part02-sleeping/07-waitqueue.md) と [アトミック操作とメモリバリア](../part00-foundation/01-atomic-barrier.md) を読んでいること。
...
`CONFIG_FUTEX_PI` は `FUTEX` と `RT_MUTEXES` に依存し、PI futex 用である（第18章）。
...
- [requeue と PI futex](18-futex-requeue-pi.md)
