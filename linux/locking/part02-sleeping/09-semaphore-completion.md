...
- [waitqueue](08-waitqueue.md) と [mutex と optimistic spinning](05-mutex-osq.md) を読んでいること。
...
completion は「作業完了の一回限りの通知」に特化し、RCU の `synchronize_srcu` 内部でも `completion` が使われる（第15章）。
...
- [SRCU](../part04-rcu/15-srcu.md)
- [Tree RCU と grace period](../part04-rcu/13-tree-rcu-gp.md)
