...
- [RCU の基本概念と API](12-rcu-basics.md) と [Tree RCU と grace period](13-tree-rcu-gp.md) を読んでいること。
- [SRCU](15-srcu.md) と対比すると、Tasks Trace は明示 read-side を持ち、classic はタスク走査で GP を完了させる点が異なる。
