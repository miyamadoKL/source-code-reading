...
- [Tree RCU と grace period](13-tree-rcu-gp.md) と [call_rcu と callback 処理](17-call-rcu-callback.md) を読んでいること。
...
- [プロセスとスケジューラのプリエンプション](../../sched/part01-core/11-preemption-model.md)
