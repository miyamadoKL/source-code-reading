...
- [Tree RCU と grace period](11-tree-rcu-gp.md) を読んでいること。
...
`lazy` フラグにより callback はしばらくメインリストから隔離され、GP 開始が遅れる（第14章の RCU_LAZY と関連）。
...
- [expedited と nocb などの発展](14-expedited-nocb.md)
- [SRCU](12-srcu.md)
