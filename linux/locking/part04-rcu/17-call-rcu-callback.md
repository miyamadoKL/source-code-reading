...
- [Tree RCU と grace period](13-tree-rcu-gp.md) と [SRCU](15-srcu.md) を読んでいること。
...
`lazy` フラグにより callback はしばらくメインリストから隔離され、GP 開始が遅れる（第18章の RCU_LAZY と関連）。
