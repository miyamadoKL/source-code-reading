...
`tick_broadcast_mask` と `tick_handle_oneshot_broadcast` の流れを読み、[第16章 NO_HZ](16-no-hz.md) の dyntick idle と接続する。

## 前提

- [第14章 tick デバイスと周期 tick](14-tick-device.md) で per-CPU `tick_device` を読んでいること。
