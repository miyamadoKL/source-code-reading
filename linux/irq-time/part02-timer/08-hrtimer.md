...
- [第7章 タイマーホイール](07-timer-wheel.md) で jiffies ベースの `timer_list` を読んでいること。
- [第9章 clocksource と clockevents](09-clocksource-clockevents.md) で `clock_event_device` の役割を先読みしてもよい。
...
- [第7章 タイマーホイール](07-timer-wheel.md)
