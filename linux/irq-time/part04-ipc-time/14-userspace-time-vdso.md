...
[全体像と横断基盤 第8章 vDSO](../../foundation/part02-syscall/08-vdso.md) で触れた入口から、timekeeper が公開するデータページとの接続を読む。

## 前提

- [第10章 timekeeping](../part02-timer/10-timekeeping.md) で `ktime_get_real_ts64()` と `tk_fast` を読んでいること。
- [全体像と横断基盤 第7章 entry 64 システムコール入口](../../foundation/part02-syscall/07-entry-64-syscall-entry-exit.md) で syscall 入口を読んでいること。
...
- [全体像と横断基盤 第8章 vDSO](../../foundation/part02-syscall/08-vdso.md)
- [第9章 clocksource と clockevents](../part02-timer/09-clocksource-clockevents.md)
