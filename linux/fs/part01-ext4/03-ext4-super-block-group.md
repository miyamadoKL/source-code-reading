# 第3章 ext4 の super block と block group
...
- [fill_super とマウント接続の流れ](../part00-overview/01-fs-registration-mount-entry.md)
...
- 次章：[ext4 の inode と inode table](04-ext4-inode-table.md)
- [ディスクレイアウトの読み方](../part00-overview/02-on-disk-layout-reading.md)
