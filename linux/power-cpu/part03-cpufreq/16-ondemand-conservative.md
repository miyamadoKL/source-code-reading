# 第16章 ondemand と conservative ガバナ
...
第15章の DBS 基盤の上に載る **ondemand** と **conservative** の周波数決定ロジックを追う。
`dbs_update` による負荷サンプリングと、上昇・下降ポリシーの違いを押さえる。

## 前提

- [第15章 schedutil ガバナ連携](15-cpufreq-governor-schedutil.md) の `dbs_update` と `dbs_update_util_handler`
...
- 前章：[schedutil ガバナ連携](15-cpufreq-governor-schedutil.md)
- [第4部 cpuidle](../part04-cpuidle/17-cpuidle-framework-driver.md) の idle 状態選択
